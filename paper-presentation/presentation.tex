...
\begin{frame}
	...
	E.g. we're generating a  waveform. Given ``0.0609, 0.305, -0.434'', what's the best next value to pick? $y[n] = f(x[n])$, some complex non-linear function based on waveforms $x[n]$ seen in training.
\end{frame}
