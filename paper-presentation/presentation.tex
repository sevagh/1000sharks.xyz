...
\begin{frame}
	...
	\begin{figure}
	\includegraphics[height=5cm]{./1_5_tonotopic.jpg}
		\caption{Tonotopic organization of the inner ear\footfullcite{tonotopic}}
	\end{figure}
\end{frame}
...
\begin{frame}
	\frametitle{Waveforms (human pov)}
	\begin{figure}
	\includegraphics[height=5.5cm]{./1_7_auditory_pathway.jpg}
		\caption{Ascending auditory pathways \footfullcite{auditorypathway}}
	\end{figure}
\end{frame}
...
\begin{frame}[fragile]
	\frametitle{How meaningful is the digital waveform?}
	\begin{small}
	\begin{verbatim}
		>> disp(x(50:128));
		    0.0609
