...
from drumnet.model import PedalNet
...
def predict(args):
    ...
    model.eval()
    train_data = hickle.load(args.train_data)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data", default="data.hdf5")
    parser.add_argument("--batch_size", type=int, default=16)
    parser.add_argument("--sample_time", type=float, default=100e-3)
    parser.add_argument("--n-pool", type=int, default=multiprocessing.cpu_count(), help="multiprocessing pool size")
